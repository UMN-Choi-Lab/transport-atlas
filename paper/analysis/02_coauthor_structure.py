...
def main() -> int:
    ...
    fig.suptitle("Coauthor network — degree and strength distributions",
                 fontsize=10)
    fig.tight_layout()
    ...
    ax.set_title("Giant coauthor component fraction over time")
    ...
    ax.set_title("Top-100 bridge edges — cross-community pair count")
